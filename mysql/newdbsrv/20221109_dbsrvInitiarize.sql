...
INSERT INTO `settings` VALUES (1,'tempError','How much margin of error is acceptable? [℃]','0.45',NULL),(2,'samplingNumber','How many times is the data acquired considered steady-state? [-]','100',NULL),(3,'interval','Interval of temperature acquisition for steady-state [s]','3',NULL),(4,'maxTime','How much is maximum steady-state waiting time? [s]','2400',NULL),(5,'tempStep','Difference between the value used as a step and the desired set value for the temperature control [℃]','0.7',NULL),(6,'monitorInterval','Interval for status monitoring [s]','5',NULL),(7,'dtempError','default','0.45',NULL),(8,'dsamplingNumber','default','100',NULL),(9,'dinterval','default','3',NULL),(10,'dmaxTime','default','2400',NULL),(11,'dtempStep','default','0.7',NULL),(12,'dmonitorInterval','default','5',NULL);
...
-- Dump completed on 2022-10-31 17:20:36
