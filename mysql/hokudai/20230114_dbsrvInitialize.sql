...
INSERT INTO `settings` VALUES (1,'tempError','How much margin of error is acceptable? [℃]','0.45','2023-01-10 06:59:42'),(2,'samplingNumber','How many times is the data acquired considered steady-state? [-]','100','2023-01-10 06:59:42'),(3,'interval','Interval of temperature acquisition for steady-state [s]','3','2023-01-10 06:59:42'),(4,'maxTime','How much is maximum steady-state waiting time? [s]','2400','2023-01-10 06:59:42'),(5,'tempStep','Difference between the value used as a step and the desired set value for the temperature control. [℃]','0.7','2023-01-10 06:59:42'),(6,'monitorInterval','Interval for status monitoring [s]','2','2023-01-10 06:59:42'),(7,'dtempError','default','0.45',NULL),(8,'dsamplingNumber','default','100',NULL),(9,'dinterval','default','3',NULL),(10,'dmaxTime','default','2400',NULL),(11,'dtempStep','default','0.7',NULL),(12,'dmonitorInterval','default','5',NULL);
...
-- Dump completed on 2023-01-14 23:53:03
