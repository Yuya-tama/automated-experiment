...
<div>
    <div class="uk-card uk-card-body uk-card-default">
        ...
        <ul class="uk-switcher uk-margin" id="edit-procedure-contents">
            ...
            <li><!-- ループ機能-->
                <div class="uk-card uk-card-body uk-card-default">
                    <edit-duplicate-block ref="editDuplicateBlock" :editBlockParent="editBlock" 
                     @submitDuplicateCondition="submitDuplicateCondition"></edit-duplicate-block>
                </div>
            </li>
            ...
            <li><!-- 編集 -->
                <div class="uk-card uk-card-body uk-card-default">
                    ...
                    <ul class="uk-switcher uk-margin" id="subnav-rename-procedure-contents">
                        ...
                        <li>
                            <edit-block-vue ref="editBlockVue" :editBlockParent="editBlock" 
...
export default {
  props: ["editOutline","editBlock","editTitle","editDevice",],
  ...
  computed:{
      ...
      deviceTypeListTemp: function(){
        let device = this.$store.state.deviceTypeList.filter(x => x.device_type_name !== 'No device' )
        return device
      },
      ...
      actionList: function(){
          ...
          if(this.addDeviceRadio == 'newDev'){
              ...
              let action = this.$store.state.actionLinkList.filter(x => x.device_type_id == id);
              return action
      ...
      detailChoice:function(){
          ...
          let valueChoice = this.$store.state.valueChoiceList.filter(x => x.device_link_id == id);
      ...
      conditionChoice: function(){
        let id = this.addSelectedAction.id;
        let conditionChoice = this.$store.state.conditionList.filter(x => x.device_link_id == id);
