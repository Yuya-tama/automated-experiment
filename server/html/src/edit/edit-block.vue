...
<div>
    ...
    <edit-detail-modal :editedDetail="editedDetail" 
    @reviseBlockDetail="reviseBlockDetail" ref="editDetailModal"></edit-detail-modal>
    <edit-condition-modal :editedCondition="editedCondition" @submitReviseCondition="submitReviseCondition"></edit-condition-modal>
</div>
</template>
...
export default {
    ...
    methods:{
        ...
        conditionFilter(outlineId){
            this.editCondition = this.$store.state.conditionList.filter(function(elem){
                return elem.experiment_procedure_id == outlineId;
            });
        },
        ...
        detailEdit(a){
            ...
            let deviceIdFiltered = this.$store.state.actionLinkList.filter(function(elem){
        ...
        conditionTitle(conditionId){
            ...
            const title = this.$store.state.conditionList.find(elem => elem.id == conditionId);
            if(title == -1){
                return null
            }
