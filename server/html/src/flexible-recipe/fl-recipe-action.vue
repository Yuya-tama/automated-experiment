        ...
        <div class='uk-modal-body'>
            <div uk-grid>
                ...
                <div class='uk-width-1-2'>
                    ...
                    <optgroup v-for="socket in $store.state.deviceList" :key="socket.socket" :label="socket.clientData.name">
...
export default{
    props:['recipeTitle','recipeOutline','recipeBlock','recipeCondition','notConcatRecipeBlock'],
